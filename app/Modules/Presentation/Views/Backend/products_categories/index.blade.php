...
@section('content')
    <div class="header sticky-top">
        <h4><i class="fa fa-file-text-o"></i> {{ trans('Backend::products_categories.page_title') }}</h4>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-5 form-group">
                    ...
                    @include('Backend::layouts.html.btn_reset', ['route' => 'ProductsCategoriesIndex'])
                </div>
                <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <!-- Button Add-->
                    @include('Backend::layouts.html.btn_add', ['route' => 'ProductsCategoriesInsert'])
                </div>
            </div>
            ...
            <table class="table table-striped">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($item->status == \App\Modules\Domain\Models\ProductsCategories::STATUS_PUBLISHED)
                                <i class="fa fa-check color-green"></i>
                            @elseif ($item->status == \App\Modules\Domain\Models\ProductsCategories::STATUS_UNPUBLISHED)
                                <i class="fa fa-times color-red"></i>
                            @endif
                        </td>
                        <td>
                            <a href="{{ route('ProductsCategoriesEdit', $item->id) }}">
                                @if($item->depth > 0)
                                    |
                                @endif

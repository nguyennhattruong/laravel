...
@section('content')
    <div class="header sticky-top">
        <h4><i class="fa fa-file-text-o"></i> Products</h4>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-5 form-group">
                    ...
                    @include('Backend::layouts.html.btn_reset', ['route' => 'ProductsIndex'])
                </div>
                <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                <!-- Button Add-->
                    @include('Backend::layouts.html.btn_add', ['route' => 'ProductsInsert'])
                </div>
            </div>
            ...
            <table class="table table-striped">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($item->status == \App\Modules\Domain\Models\Products::STATUS_PUBLISHED)
                                <i class="fa fa-check color-green"></i>
                            @elseif ($item->status == \App\Modules\Domain\Models\Products::STATUS_UNPUBLISHED)
                                <i class="fa fa-times color-red"></i>
                            @endif
                        </td>
                        <td>
                            <img width="64" src="{{ getThumbImage($item->images[0], 'define.folder.products_thumb') }}">
                        </td>
                        <td>
                            <a href="{{ route('ProductsEdit', $item->id) }}">
                                @if($item->depth > 0)
                                    |
                                @endif

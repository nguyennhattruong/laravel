...
@section('content')
    <div class="header sticky-top">
        <h4><i class="fa fa-file-text-o"></i> Pages</h4>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-5 form-group">
                    ...
                    @include('Backend::layouts.html.btn_reset', ['route' => 'PagesIndex'])
                </div>
                <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                <!-- Button Add-->
                    @include('Backend::layouts.html.btn_add', ['route' => 'PagesInsert'])
                </div>
            </div>
            ...
            <table class="table table-striped">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('PagesEdit', $item->id) }}">
                                @if($item->depth > 0)
                                    |
                                @endif
                                {{ str_repeat('- ', $item->depth) }} {{ $item->title }}</a><br>
                            <small>
                                <a class="color-light-black" target="_blank"
                                   href="{{ route('SitePages', $item->alias) }}">{{ route('SitePages', $item->alias) }}</a>
                            </small>
                        </td>
    ...
    <script type="text/javascript" src="{{ asset('public/js/admin/pages/index.js') }}"></script>
@endsection

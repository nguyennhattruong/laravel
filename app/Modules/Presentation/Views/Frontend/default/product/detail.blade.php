...
@section('content')
    ...
    <section class="container py-2" style="max-width: 1200px">
        <div class="row">
            @if(!empty($data))
                <div class="col-md-12 mb-4">
                    <section class="p-4 bg-white">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <header>
                                    <h1 class="font-roboto-condensed color-black font-size-2">{{ $data->title }}</h1>
                                </header>
                                <section>
                                    <p>
                                        <span>Mã:</span>
                                    ...
                                    <p>
                                        <a href="#" class="btn btn-success btn-lg" data-id="{{ $data->id }}"
                                           data-coco="addCart"><i class="fas fa-shopping-cart"></i>
                                            Thêm giỏ hàng</a>
                                        <a href="#" class="btn btn-danger btn-lg">Mua ngay</a>
                                    </p>
                                </section>
                            </div>
                            <div class="col-md-9">

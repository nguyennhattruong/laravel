        ...
        <div class="overlay overlay-black">
            ...
            <div class="position-absolute-center" style="top:-50px">
                <div>
                    ...
                    <div class="display-4 font-play color-white">Tìm kiếm căn hộ</div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="bg-white p-3 rounded">
                                <p class="font-size-1d5 color-black">Từ khóa: "{{ $keyword }}"</p>
                                <span class="color-black">Kết quả:</span>
                                <span class="color-red font-weight-bold">{{ $list->total() }}</span>
                                <span class="color-black font-weight-bold">căn hộ</span>
